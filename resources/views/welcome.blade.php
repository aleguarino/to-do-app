...
<body class="flex flex-col h-screen">
    <header>
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TaskO</span>
                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full"
                            src="https://c0.klipartz.com/pngpicture/11/510/sticker-png-computer-icons-colorado-state-university-user-profile-miscellaneous-service.png"
                            alt="user photo">
                    </button>
                    <!-- Dropdown menu -->
    ...
    <main class="flex-1 flex w-auto">
        <!-- Sidebar -->
        <div class="flex flex-col justify-between w-24 bg-white">
        ...
        <div class="flex-1 w-full bg-gray-200">
            ...
            <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error, iusto doloremque
                unde
                maiores consectetur at voluptates expedita rem quas similique saepe odit quos asperiores quidem
                dicta
                officia iure autem necessitatibus!</div>
        </div>
    </main>
